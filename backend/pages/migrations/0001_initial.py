    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_background_size', models.CharField(choices=[('auto', 'Auto'), ('cover', 'Cover'), ('contain', 'Contain')], default='cover', max_length=20, verbose_name='Default background size')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link', models.CharField(max_length=50, unique=True, validators=[django.core.validators.RegexValidator(regex='^[/]([a-z0-9]?)+(?:-[a-z0-9]+)*$')], verbose_name='Link')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_form_email', models.EmailField(blank=True, max_length=254, verbose_name='Contact form email')),
            ],
            options={
